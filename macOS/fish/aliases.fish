...
alias capdev='cd $HOME/.captain/headproxy'


#============ Programming ===========
alias gbpurge='git fetch --prune && git branch --merged | grep -E -v "\*|master|main|develop|dev|stage|qa" | xargs -n 1 git branch -d'
alias xdb='echo "?XDEBUG_SESSION_START=PHPSTORM"'
alias modev='$HOME/dotfiles/macOS/bash/scripts/madoffice.sh'
